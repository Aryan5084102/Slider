  ...
  return (
    <div className="w-full min-h-screen">
          ...
          <SwiperSlide key={index}>
            <div className="flex flex-col md:flex-row justify-center items-center h-screen">
              ...
              <div className="w-full md:w-1/2 px-4 md:px-8">
                ...
                {/* Search Box */}
                <div className="flex flex-col sm:w-[200px] sm:flex-row items-center sm:items-stretch justify-between shadow-lg mb-6 bg-white rounded-3xl px-4 py-2 w-full  md:w-[500px] space-y-2 sm:space-y-0">
                  <input
                    type="text"
                    placeholder="Search for colleges and courses"
                    className="outline-none border-none p-2 w-full sm:w-40 text-sm md:text-base"
                  />
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-yellow-400 hover:bg-yellow-500 cursor-pointer">
      ...
      <div className="absolute top-64 -right-14 cursor-pointer z-10 -rotate-90 bg-[#e89e26] w-32 sm:w-40 py-1 sm:py-2 justify-center items-center rounded-lg flex gap-1">
        ...
        <div className="text-xs sm:text-sm lg:text-lg font-semibold">
          Enquiry Now
        </div>
      </div>
    </div>
